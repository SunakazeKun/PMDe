...
public class PokemonEditor extends AbstractEditor {
    ...
    protected void initProperties() {
        ...
        cmoWalkable.setModel(new DefaultComboBoxModel(new String[] { "Normal", "Magma, Water", "Magma, Water, Sky", "Magma, Water, Sky, Wall", "Magma", "Water" }));
        cmoShadow = new JComboBox();
        cmoShadow.setModel(new DefaultComboBoxModel(new String[] { "Small", "Medium", "Large" }));
        ...
        Object[] evolveTypes = { "Nothing", "Level", "IQ", "Item", "Link Cable", "Attack > Defense", "Attack < Defense", "Attack = Defense", "Sun Ribbon", "Lunar Ribbon", "Beauty Scarf", "50% (Silcoon)", "50% (Cascoon)", "Trade" };
        ...
        properties.addLabeledComponent(lblCategory, txtCategory);
        properties.addLabeledComponent(lblCategoryPointer, txtCategoryPointer);
        properties.addSeparator();
        properties.addCaption("General");
        properties.addLabeledComponent(lblArea, cmoArea);
        properties.addLabeledComponent(lblWalkable, cmoWalkable);
        properties.addLabeledComponent(lblShadow, cmoShadow);
        properties.addLabeledComponent(lblSize, sdrSize);
        properties.addLabeledComponent(lblSpeed, sdrSpeed);
        properties.addComponent(chkMove);
        properties.addSeparator();
        properties.addCaption("Stats");
        properties.addLabeledComponent(lblType1, cmoType1);
        properties.addLabeledComponent(lblType2, cmoType2);
        properties.addLabeledComponent(lblAbility1, cmoAbility1);
        properties.addLabeledComponent(lblAbility2, cmoAbility2);
        properties.addLabeledComponent(lblEXP, spnEXP);
        properties.addLabeledComponent(lblHP, spnHP);
        properties.addLabeledComponent(lblAtk, spnAtk);
        properties.addLabeledComponent(lblDef, spnDef);
        properties.addLabeledComponent(lblSpAtk, spnSpAtk);
        properties.addLabeledComponent(lblSpDef, spnSpDef);
        properties.addSeparator();
        properties.addCaption("Evolution");
        properties.addLabeledComponent(lblEvolveFrom, cmoEvolveFrom);
        properties.addLabeledComponent(lblEvolveType, cmoEvolveType);
        properties.addLabeledComponent(lblEvolveParam, spnEvolveParam);
        properties.addLabeledComponent(lblEvolveAdditional, cmoEvolveAdditional);
        properties.addSeparator();
        properties.addCaption("Indexes");
        properties.addLabeledComponent(lblInternalNo, spnInternalNo);
        properties.addLabeledComponent(lblParentNo, spnParentNo);
        properties.addLabeledComponent(lblDexNo, spnDexNo);
        properties.addLabeledComponent(lblAlphaNo, spnAlphaNo);
        properties.addSeparator();
        properties.addCaption("Misc.");
        properties.addLabeledComponent(lblFaces, txtFaces);
        properties.addLabeledComponent(lblPalette, sdrPalette);
        properties.addLabeledComponent(lblRecruit, spnRecruit);
        properties.addLabeledComponent(lblLowKick, spnLowKick);
        properties.addLabeledComponent(lblSizeBust, spnSizeBust);
        properties.addSeparator();
        properties.addCaption("Unknown");
        properties.addLabeledComponent(lblUnk1A, spnUnk1A);
        properties.addLabeledComponent(lblUnk1B, spnUnk1B);
        properties.addLabeledComponent(lblUnk1D, spnUnk1D);
        properties.addLabeledComponent(lblUnk22, spnUnk22);
        properties.addLabeledComponent(lblUnk30, spnUnk30);
        properties.addLabeledComponent(lblUnk31, spnUnk31);
        properties.addLabeledComponent(lblUnk32, spnUnk32);
